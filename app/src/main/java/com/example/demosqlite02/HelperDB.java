...
public class HelperDB extends SQLiteOpenHelper {
    ...
    public long insertRecord(String product_name, String image, String brand, String model, String serialnumber, String price) {
    ...
    public void updateRecord(String id, String product_name, String image, String brand, String model, String serialnumber, String price) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
